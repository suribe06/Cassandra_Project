...
def interface(name):
    global session, cluster, cont_ID_carrito
    print("====================================================================")
    ...
    while flag:
        if shop == 1:
            ...
            print("Para agregar un producto al carrito escriba 'agregar' seguido del id del producto y de la cantiadad a comprar e este")
            print("Para quitar un producto del carrito escriba 'quitar' seguido del id del producto")
            ...
            while ans != 'descartar':
                ...
                if x[0] == 'agregar':
                    ...
                    rows = session.execute(
                        "select valorfinal from carrito where cliente={0} allow filtering".format(id_carrito)
                    )
